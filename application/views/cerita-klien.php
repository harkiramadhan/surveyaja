...
<body class="bg-white">
    ...
    <section class="" style="background: url('<?= base_url('/assets/images/img/bg-header.svg') ?>') no-repeat center bottom; background-size: cover; max-height: 561.5px;">
            ...
            <div class="container">
                ...
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    <li class="nav-item px-2">
                        <a class="nav-link text-uppercase fs-6 fw-normal text-white" aria-current="page" href="<?= base_url('') ?>">Beranda</a>
                    </li>
                    <li class="nav-item px-2">
                    ...
                    <li class="nav-item px-2">
                        <a class="nav-link text-uppercase fs-6 fw-normal text-white active" href="<?= site_url('klien') ?>" style="font-size: 14px !important;">Klien</a>
                    </li>
                    <li class="nav-item px-2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 pt-lg-5 pt-0 pb-5 d-flex align-content-center">
                        <div class="align-self-center" data-aos="fade-up"data-aos-anchor-placement="center-center" data-aos-easing="ease-in-sine" data-aos-duratioin="3000">
                            <h1 class="text-white fw-semibold">Lihat <span class="text-warning">Cerita</span> mereka <br> dengan <span class="text-warning">Surveyaja.com</span></h1>
                            <p class="text-white fs-5 fw-lighter mt-2">Kami berusaha memberikan kepuasan kepada client</p>
                        </div>
        ...
        <!-- <img class="position-absolute end-0" src="/assets/images/img/circle-white-end.svg" style="width: 200px;" alt=""> -->
    ...
    <section class="d-flex flex-column py-5 mt-lg-0 mt-5">
        ...
        <div class="mx-auto text-center">
            ...
            <h5 class="fw-bold">Dengarkan cerita mitra <span class="text-danger">Kami</span></h5>
            <!-- <p class="text-secondary text-decoration-underline">Simak lebih lengkap pengalaman mereka</p> -->
        </div>

        <div class="container">
            <div class="list-fitur mt-5">
                <div class="row row-cols-lg-4 row-cols-lg-4 row-cols-1">
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="<?= base_url('/assets/images/client/logo-aksipangan.png') ?>" style="height: 30px;">
                                <h5 class="fw-bold">Aksipangan.com</h5>
                                <p class="text-secondary mb-3">Proses validasi data telah menggunakan koordinat titik lokasi survey dan foto lokasi</p>
                            </div>
                            <button class="btn w-100 btn-danger btn-sm rounded-pill text-uppercase text-white fw-semibold mx-auto mt-auto" type="submit" style="padding: 10px 15px 10px 15px;">lihat Cerita</button>
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="<?= base_url('/assets/images/client/logo-observasi.png') ?>" style="height: 30px;">
                                <h5 class="fw-bold">Observasi.id</h5>
                                <p class="text-secondary mb-3">Surveyaja.com menyediakan layanan konsultasi melalui pilihan level akun yang dipilih</p>
                            </div>
                            <button class="btn w-100 btn-danger btn-sm rounded-pill text-uppercase text-white fw-semibold mx-auto mt-auto" type="submit" style="padding: 10px 15px 10px 15px;">lihat Cerita</button>
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="<?= base_url('/assets/images/client/logo-pangannews.png') ?>" style="height: 30px;">
                                <h5 class="fw-bold">Pangannews</h5>
                                <p class="text-secondary mb-3">Didukung dengan tenaga surveyor di seluruh wilayah Indonesia</p>
                            </div>
                            <button class="btn w-100 btn-danger btn-sm rounded-pill text-uppercase text-white fw-semibold mx-auto mt-auto" type="submit" style="padding: 10px 15px 10px 15px;">lihat Cerita</button>
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="<?= base_url('/assets/images/client/logo-radarsuara.png') ?>" style="height: 30px;">
                                <h5 class="fw-bold">Radar Suara</h5>
                                <p class="text-secondary mb-3">Proses input data dilakukan dengan mudah</p>
                            </div>
                            <button class="btn w-100 btn-danger btn-sm rounded-pill text-uppercase text-white fw-semibold mx-auto mt-auto" type="submit" style="padding: 10px 15px 10px 15px;">lihat Cerita</button>
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="<?= base_url('/assets/images/client/logo-panganinitiative.png') ?>" style="height: 30px;">
                                <h5 class="fw-bold">Pangan Institute</h5>
                                <p class="text-secondary mb-3">Seluruh aktivitas pengambilan data dilakukan dengan pendekatan paperless</p>
                            </div>
                            <button class="btn w-100 btn-danger btn-sm rounded-pill text-uppercase text-white fw-semibold mx-auto mt-auto" type="submit" style="padding: 10px 15px 10px 15px;">lihat Cerita</button>
    ...
    <section class="d-flex flex-column py-5 bg-danger">
        ...
        <!-- <img class="position-absolute start-0 mt--5" src="/assets/images/img/circle-white-start.svg" style="width: 200px;" alt=""> -->
    </section>
        ...
        <div class="container pb-3">
            <dev class="row">
                ...
                <div class="col-lg-3 col-12 d-flex flex-column ps-lg-5 ps-3 mt-lg-5 mt-3">
                    <a href="<?= base_url('') ?>" class="text-white mb-2 text-decoration-none">Beranda</a>
                ...
                <div class="col-lg-3 col-12 d-flex flex-column ps-lg-5 ps-3 mt-lg-5 mt-3">
                    <a href="<?= base_url('') ?>" class="text-white mb-2 text-decoration-none">Harga</a>
