...
<head>
    ...
    <title>CERITA KLIEN - SURVEYAJA.COM</title>
                ...
                <div class="row row-cols-lg-4 row-cols-lg-4 row-cols-1">
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="/assets/client/logo-aksipangan.png" style="height: 30px;">
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="/assets/client/logo-observasi.png" style="height: 30px;">
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="/assets/client/logo-pangannews.png" style="height: 30px;">
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="/assets/client/logo-radarsuara.png" style="height: 30px;">
                    ...
                    <div class="col mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-3 h-100 d-flex flex-column">
                            <div>
                                <img class="mb-4" src="/assets/client/logo-panganinitiative.png" style="height: 30px;">
