...
<head>
    ...
    <title>MEET OUR TEAM - SURVEYAJA.COM</title>
...
<body class="bg-white">
                ...
                <div class="row justify-content-center pb-5">
                    <div class="col-lg-6 col-10 pt-5 py-5">
                        <div class="align-self-center" data-aos="fade-up"data-aos-anchor-placement="center-center" data-aos-easing="ease-in-sine" data-aos-duratioin="3000">
                            <h1 class="text-white fw-semibold">Hai, <br>Kami <span class="text-warning">Surveyaja</h1>
                            <p class="text-white fs-5 fw-lighter mt-2">Memberikan Kontribusi Terbaik adalah tugas Kami</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Meet Our Team -->
    <section class="d-flex flex-column py-5" style="margin-top: -180px;">
        
        <div class="container">
            <div class="mx-auto text-center">
                <!-- <img class="mx-auto mb-2" src="/assets/icon/sec-fitur.svg" alt=""> -->
                <h4 class="fw-bold text-white">Board of Advisor</h4>
            ...
            <div class="list-fitur mt-4 col-lg-8 col-12 mx-auto">
                <div class="row row-cols-lg-3 row-cols-lg-3 row-cols-1">
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-hendra.png" alt="">
                            <h5 class="fw-bold">Hendra Hidayat, SP</h5>
                            <p class="text-secondary mb-0">Board Of Advisor</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-amaliah.png" alt="">
                            <h5 class="fw-bold">Amaliah Ekasari, SP</h5>
                            <p class="text-secondary mb-0">Board Of Advisor</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-heri.png" alt="">
                            <h5 class="fw-bold">Heri Ardin, MM</h5>
                            <p class="text-secondary mb-0">Board Of Advisor</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="mx-auto text-center">
                <!-- <img class="mx-auto mb-2" src="/assets/icon/sec-fitur.svg" alt=""> -->
                <h4 class="fw-bold">Our Awesome Team</h4>
                <!-- <p class="text-secondary px-lg-5 px-2 mx-auto">Membangun pengetahuan dan menguji hipotesa menjadi kebutuhan para data driven decision maker, <br> surveyaja.com membantu Anda menyedikan survey yang reliable membantu memprovokasi gagasan dan hipotesis Anda. </p> -->
            </div>
    
            <div class="list-fitur mt-3">
                <div class="row row-cols-lg-4 row-cols-lg-3 row-cols-1">
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-naufal.png" alt="">
                            <h5 class="fw-bold">Naufal Nur Mahdi, SE. M.Si</h5>
                            <p class="text-secondary mb-0">Co-Founder & CEO</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-alfian.png" alt="">
                            <h5 class="fw-bold">Alfian Rahmatullah. S.Kom</h5>
                            <p class="text-secondary mb-0">CTO</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-irfan.png" alt="">
                            <h5 class="fw-bold">Irfan, SKM</h5>
                            <p class="text-secondary mb-0">Head of Finance & Legal</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-non.png" alt="">
                            <h5 class="fw-bold">A. Harki Ramadhan. S.Kom</h5>
                            <p class="text-secondary mb-0">Developer</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="mx-auto text-center">
                <!-- <img class="mx-auto mb-2" src="/assets/icon/sec-fitur.svg" alt=""> -->
                <h4 class="fw-bold">Senior Surveyer</h4>
                <!-- <p class="text-secondary px-lg-5 px-2 mx-auto">Membangun pengetahuan dan menguji hipotesa menjadi kebutuhan para data driven decision maker, <br> surveyaja.com membantu Anda menyedikan survey yang reliable membantu memprovokasi gagasan dan hipotesis Anda. </p> -->
            </div>
            ...
            <div class="list-fitur mt-3">
                <div class="row row-cols-lg-4 row-cols-lg-3 row-cols-1">
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-non.png" alt="">
                            <h5 class="fw-bold">Dr. Nani Nurani Muksin</h5>
                            <p class="text-secondary mb-0">Surveyer</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-risno.png" alt="">
                            <h5 class="fw-bold">Risno Muhammad, SE, MP</h5>
                            <p class="text-secondary mb-0">Surveyer</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-basirun.png" alt="">
                            <h5 class="fw-bold">Basirun, M.Si</h5>
                            <p class="text-secondary mb-0">Surveyer</p>
                        </div>
                    </div>
                    <div class="col mb-lg-0 mb-3" data-aos="fade-up" data-aos-duratioin="3000">
                        <div class="border border-2 rounded-4 px-3 py-4 h-100 text-center bg-white">
                            <img class="mb-4" src="/assets//img/team/foto-astrid.png" alt="">
                            <h5 class="fw-bold">Astrid Nurfitria Ramadhani</h5>
                            <p class="text-secondary mb-0">Surveyer</p>
                        </div>
                    </div>
                </div>
